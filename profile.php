      ...
      <nav id="navbar" class="navbar me-1">
        <ul>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle me-0 me-lg-2 active" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Profile</a>
                <div class="dropdown-menu" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 42px);" data-popper-placement="bottom-start">
                    <form action="index.php" method="post">
                        ...
                        <button type="submit" class="btn btn-link my-2 my-sm-0">
                            Close session
                        </button>
                    </form>
                </div>
