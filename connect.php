          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="gallery-item h-100">
              ...
              <div class="gallery-links d-flex justify-content-center" style="align-items:center;">
                <div class="row m-0">
                  <div class="col-12">
                    <h5>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero dolores repellat perferendis animi excepturi deleniti vitae, quas aut amet omnis nihil numquam accusamus commodi, voluptatem modi repellendus, magni dignissimos esse. Lorem ipsum dolor s</h5>
                  </div>
